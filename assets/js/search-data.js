    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-personal-website-development",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-optimising-robotic-search-algorithms",
          title: 'Optimising Robotic Search Algorithms',
          description: "A study exploring how speed, accuracy, and thoroughness interact in robotic search systems, using the Pololu 3Pi+ platform. The project investigates search pattern parameters to enhance autonomous navigation for applications such as disaster response, industrial automation, and environmental mapping.",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%70%61%6E%74%6F%6E%66%72%61%6E%6B@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/fpant1", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/frank-panton-146926186/", "_blank");
        },
      },{
      id: 'light-theme',
